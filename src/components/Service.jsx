...
const PauseIcon = styled(AiOutlinePauseCircle)`
  width: 20px;
  margin-right: 10px;
`;
...
const Service = () => {
  ...
  return (
    <Container>
      ...
      <Right>
        <Wrapper>
          {/* if an element doesn't need any styles, then we can use normal html tag for that element */}
